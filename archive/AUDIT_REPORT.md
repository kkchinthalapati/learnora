...
### 7.6 Execution ledger

Moved to [`claude-16-9-26-work.md`](claude-16-9-26-work.md) (root) so it can be picked up on a new branch. It records per-task state, the open Task 4 finding, rulings, deferred minors and resume steps.
